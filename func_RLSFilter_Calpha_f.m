...
%     d = Lambda: is the convergence rate parameter. It is also called the "forgetting" exponential weight factor
%     FIR_Num£º is the filter length
%     delta_n£º are the initial diagonal R^{-1}(n) matrix elements.
%     Example:
